...
const remoteAudio =
  'https://voiceoverapi.digitalgalaxy.cn/files/video/video/Grandpa%2C%20what%20are%20you%20doing_.mp3';

class App extends Component {
  constructor() {
    super();
    RNVoiceComparison.setup(
      'bakhtiyor.k@gmail.com',
      '5e2a1bbe-3e91-46b3-ac3e-3cb066f945b6',
    ...
    RNVoiceComparisonEmitter.addListener(
      'onVoiceComparisonError',
      this.onVoiceComparisonError,
    );
    RNVoiceComparisonEmitter.addListener(
      'onVoiceComparisonScore',
      this.onVoiceComparisonScore,
    );
    RNVoiceComparisonEmitter.addListener(
      'onVoiceComparisonResult',
      this.onVoiceComparisonResult,
    );
  }
      ...
      <Fragment>
        ...
        <SafeAreaView style={{flex: 1}}>
          <View style={styles.sectionTitle}>
            <Text style={styles.sectionTitleText}>VoiceComparison</Text>
          </View>
          <TextInput
          ...
          <View style={{flexDirection: 'row', marginBottom: 15}}>
            <Button
              ...
              title={
                this.state.downloading ? 'Downloading...' : 'Download Audio1'
              }
            />
            <Button
              color="green"
          ...
          <Button onPress={this._onPressButton} title="Run" />
